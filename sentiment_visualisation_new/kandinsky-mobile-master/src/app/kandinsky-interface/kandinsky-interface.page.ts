...
export class KandinskyInterfacePage implements OnInit {
  ...
  async openSentimentAnalysisModal(neg_sentiment_score: number, neu_sentiment_score: number, pos_sentiment_score: number, compound_sentiment_score: number, content: string) {
    console.log("enters openSentimentAnalysisModal");
    const sentiment_scores = [neg_sentiment_score, neu_sentiment_score, pos_sentiment_score]
    ...
    const modal = await this.modalController.create({
        ...
        componentProps: {
          ...
          commentScore: compound_sentiment_score
        }
    });
