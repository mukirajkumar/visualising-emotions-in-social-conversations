    ...
    const socialComments: SocialComment[] = await socialPlatform.getComments(postId, areCommentsInStorage, !areCommentsInStorage)
      ...
      .then(async (comments) => {
        if (areCommentsAnalyzed) {
          return await socialPlatform.sentimentanalyseComments(postId);
        }
        ...
        return await socialPlatform.sentimentanalyseComments(postId); // Reference sentimentanalyzeComments function
